// Forked from https://github.com/neptunian/react-photo-gallery
    ...
    render(){
        ...
        for (var i=0;i<this.props.photos.length;i+=rowLimit){
            ...
            for (var k=i; k<i+rowLimit; k++){
                ...
                var imgWidth = commonHeight * this.props.photos[k].aspectRatio;
                photoPreviewNodes.push(
                     <div key={k} style={style}>
                        <a href="#" className={k} onClick={this.openLightbox.bind(this, k)}>
                            <Image src={src} style={{display:'block', border:0}} height={commonHeight} width={imgWidth} alt="" />
                        </a>
                     </div>
                );
            }
